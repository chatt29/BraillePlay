...
public class NumberFlow10_1InputHandler : MonoBehaviour
{
    [Header("Dot Visuals")]
    public Image dot1;
    public Image dot2;
    ...
    void SubmitPattern()
    {
        // Target Number Flow 10-1 Script
        NumberFlow10_1Script numberFlow = FindObjectOfType<NumberFlow10_1Script>();
