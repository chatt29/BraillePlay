...
public class RimesItIpIgIdInIll : MonoBehaviour
{
    // -------------------------------------------------------------------------
    ...
    // -------------------------------------------------------------------------
    // Scene Text — UPDATED FOR LESSON 15
    // -------------------------------------------------------------------------
    [Header("Scene Text")]
    [TextArea(2, 5)]
    public string welcomeMessage = "Welcome to Lesson 15: I Word Families!";

    [TextArea(2, 5)]
    public string letsLearnMessage = "Let's find the letter I in the middle of words.";

    [TextArea(2, 5)]
    public string completedMessage = "Amazing! You spelled all the -it, -ip, -ig, -id, -in, and -ill words!";

    [TextArea(2, 5)]
    public string repeatQuestionMessage = "You finished Lesson 15. Do you want to practice again? Press R to repeat or Y to finish.";
    ...
    // -------------------------------------------------------------------------
    // Private State — REST IS IDENTICAL TO YOUR GROUPMATE'S SCRIPT
    // -------------------------------------------------------------------------
    ...
    {
        if (logDebug)
            Debug.Log("Lesson 15 RimesItIpIgIdInIll started.");
